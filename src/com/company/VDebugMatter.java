...
public class VDebugMatter extends VMatter {
    ...
    public VDebugMatter(double posX, double posY, double mass) {
     ...
     * @param mass
     */
    VDebugMatter(double velocityX, double velocityY, double posX, double posY, double mass) {
